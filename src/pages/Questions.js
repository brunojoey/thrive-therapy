    ...
    <div className="content">
      ...
      <section className="question">
        ...
        <div className="question-card">
          ...
          <p>
            Parking is available on Franklin Street in front of the building or
            in the public parking lot next to the Farmers Market.
          </p>
        </div>
        <div className="question-card">
          <h2>What is Your Cancellation Policy?</h2>
          <p>
            If you need to cancel your appointment, a cancellation must be
            communicated via phone or email at least 24 hours prior to the
            appointment time.
          </p>
        </div>
        <div className="question-card">
          <h2>What Ages Do You Work With and Where Are Services Provided?</h2>
          <p>
            Thrive Pediatric Therapy provides services to individuals from birth
            to 23 years old. Services are provided at 170 W. Franklin Street
            Gallatin, TN 37066. Teletherapy services are provided on a case by
            case basis to best serve our clients.
          </p>
        </div>
      </section>
    </div>
